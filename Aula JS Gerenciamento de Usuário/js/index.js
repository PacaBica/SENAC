...
document.querySelector('#salvar').addEventListener('click', () => {
    ...
    let nasc = document.querySelector('#exampleInputBirth').value;
    ...
    let json = {nome: nome, genero: genero, nasc: nasc, pais: pais, email: email, 
        senha: senha, foto: foto, admin: admin};
...
function addLinha (usuario) {
    ...
    tr.innerHTML = `
    <td><img src="./dist/img/user7-128x128.jpg" alt="Imagem do usuário" class="img-sm img-circle"></td> 
    <td>${usuario.nome}</td> 
    <td>${usuario.email}</td> 
    <td>${usuario.admin}</td> 
    ...
    data-target="#modalExcluir">Excluir</button></td>`;
